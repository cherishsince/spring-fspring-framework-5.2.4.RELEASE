...
/**
 * 可用于获取包装的{@link Serializable}的内部实用程序类
 * {@link的变体java.lang.reflect语言.类型java.lang.reflect语言。类型}。
 * <p>{@link#forField（Field）Fields}或{@link#forMethodParameter（MethodParameter）
 * MethodParameters}可以用作可序列化类型的根源。
 * 或者，常规的{@link类}也可以用作源。
 * <p>
