...
public class AbstractTemplateViewResolver extends UrlBasedViewResolver {
	...
	/**
	 * 当 RequestAttributes 中存在 Model 中同名的参数，
	 * 是否允许使用 RequestAttributes 中的值将 Model 中的值进行覆盖
	 */
	...
	/**
	 * 当 SessionAttributes 中存在 Model 中同名的参数，
	 * 是否允许使用 SessionAttributes 中的值将 Model 中的值进行覆盖
	 */
